            ...
            <div className="CreateDataScopeForm">
                    ...
                    <table className="roles_tbl">
                      <thead>
                        <tr>
                          ...
                          <th className="role_descrHeader">Role Description</th>
                        </tr>
                      </thead>
                      <tbody>
                        {roles.map((role, key) => {
                          return (
                            <tr key={key}>
                              <td>{role.role}</td>
                              <td className="roledescription_Table">{role.roledescription}</td>
                            </tr>
                          );
                        })}
                      </tbody>
              ...
              <div className="datascope_addrole">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                />
                <button className="AddRoleButton" onClick={handleAddRole} type="button">
                  Add Role
                </button>
              </div>
            </div>
