      ...
      <div className="viewDeviceOverlay">
        <div className="viewDeviceBorder">
          ...
          <div className="viewDeviceDescriptionDiv">
            ...
            <textarea readOnly={true} className="viewDescription">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet dolorem dolores est fuga iste iure libero nam nemo nihil non officiis optio, placeat quos ratione, saepe temporibus tenetur, ullam ut.</textarea>
          </div>
