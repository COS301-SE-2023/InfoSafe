...
const EditDevice = ({ asset, popupClose, popupOpen, onAssesEdited }) => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(request);
        fetch('https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/asset/update/' + asset.asset_id, {
            method:"PUT",
    ...
    useEffect(() => {
        fetch("https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/user/findUserNotAssigned/" + asset.asset_id, {
            method: "GET",
            headers: {
                Authorization: "Bearer " + sessionStorage.getItem('accessToken')
            }
