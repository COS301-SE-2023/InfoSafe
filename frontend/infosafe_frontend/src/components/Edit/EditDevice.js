...
const EditDevice = ({ asset, popupClose, popupOpen, onAssesEdited }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (
            (request.asset_name === '' || request.asset_description === '' || request.device_type === '') ||
            (request.availability === 'No' && request.current_assignee === null)
        ) {
                ...
                <div className="popupBackground">
                    <div className="borderEditDevice">
                        <form onSubmit={handleSubmit}>
                            ...
                            <p className="editDeviceError" id="editDeviceError">Please ensure all fields are completed and that if an asset's availability is set to "No," a user is assigned to it</p>
