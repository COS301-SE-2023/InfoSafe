...
export const ViewTask = ({task, popupClose, popupOpen}) => {
    ...
    const [addUsers, setAddUsers] = useState([]);
        ...
        useEffect(() => {
            fetch("http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/task/getUsersOfTask/" + task.task_id, {
                method: "GET",
                headers: {
    ...
    const handleCompleted = () => {
        ...
        fetch("http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/task/completeTask", {
            method: "POST",
            headers: {
