...
export const CreateDataScopePopup = ({popupOpen, popupClose}) => {
    ...
    const handleClick = (e) => {
        ...
        fetch(`http://ec2-174-129-77-195.compute-1.amazonaws.com:80/api/datascope/checkName?dsname=${ds_name}`,{
            method: "GET",
            headers: {
            ...
            .then((data) => {
                if (data) {
                    ...
                    fetch("http://ec2-174-129-77-195.compute-1.amazonaws.com:80/api/datascope/addDs", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            Authorization: "Bearer " + sessionStorage.getItem('accessToken'),
                    ...
                    fetch("http://ec2-174-129-77-195.compute-1.amazonaws.com:80/api/dataScopeRole/addDataScopeRole", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            Authorization: "Bearer " + sessionStorage.getItem('accessToken'),
    ...
    useEffect(() => {
        fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:80/api/dataScopeRole/getDataScopeRole', {
            method: "GET",
            headers: {
                Authorization: "Bearer " + sessionStorage.getItem('accessToken')
            }
    ...
    useEffect(() => {
        fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:80/api/user/getId', {
            method: "GET",
            headers: {
                Authorization: "Bearer " + sessionStorage.getItem('accessToken')
            }
