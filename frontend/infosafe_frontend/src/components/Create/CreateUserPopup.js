...
export const CreateUserPopup = ({ popupOpen, popupClose, onUserAdded }) => {
    ...
    const useHandleClick = (e) => {
        ...
        fetch(`http://infosafe.live:8080/api/user/checkEmail?email=${email}`, {
            method: "GET",
            headers: {
            ...
            .then((data) => {
                if (data) {
                    ...
                    //console.log(user);
                    fetch("http://infosafe.live:8080/api/user/add", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            Authorization: "Bearer " + sessionStorage.getItem('accessToken'),
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("http://infosafe.live:8080/api/randPass/generate", {
                    method: "GET",
    ...
    useEffect(() => {
            fetch("http://infosafe.live:8080/api/role/getRoleNames", {
                method:"GET",
                headers:{"Content-Type":"application/json",
                    Authorization: "Bearer " + sessionStorage.getItem('accessToken')
                },
