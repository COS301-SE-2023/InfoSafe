...
export const CreateDevicePopup = ({popupOpen, popupClose, onAssetCreated}) => {
    ...
    const handleClick = (e) => {
        ...
        // console.log(asset);
        popupClose()
        fetch("https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/asset/addAsset", {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch("https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/user/getAll", {
            method: "GET",
            headers: {
                Authorization: "Bearer " + sessionStorage.getItem('accessToken')
            }
