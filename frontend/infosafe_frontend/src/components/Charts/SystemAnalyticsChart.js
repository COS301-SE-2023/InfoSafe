...
const SystemAnalyticsChart = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const fetchPromises = [
                await fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/datascope/getTotal', {
                    method: "GET",
                    headers: {
                        Authorization: "Bearer " + accessToken,
                    },
                }),
                await fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/user/dataScopeCount', {
                    method: "GET",
                    headers: {
                        Authorization: "Bearer " + accessToken,
                    },
                }),
                await fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/user/countDevices', {
                    method: "GET",
                    headers: {
                        Authorization: "Bearer " + accessToken,
                    },
                }),
                await fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/asset/getTotalAssets', {
                    method: "GET",
                    headers: {
                        Authorization: "Bearer " + accessToken,
                    },
                }),
                await fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/user/taskCount', {
                    method: "GET",
                    headers: {
                        Authorization: "Bearer " + accessToken,
                    },
                }),
                await fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/task/totalTasks', {
                    method: "GET",
                    headers: {
                        Authorization: "Bearer " + accessToken,
                    },
                }),
                await fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/supportrequest/getTotal', {
                    method: "GET",
                    headers: {
                        Authorization: "Bearer " + accessToken,
                    },
                ...
                await fetch('http://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/assetrequest/getTotal', {
                    method: "GET",
                    headers: {
                        Authorization: "Bearer " + accessToken,
                    },
