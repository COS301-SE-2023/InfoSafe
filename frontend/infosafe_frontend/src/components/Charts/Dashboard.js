...
export const Dashboard = () => {
        ...
        useEffect(() => {
            const fetchData = async () => {
                ...
                const fetchPromises = [
                    await fetch('https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/notifications/getNotifications', {
                        method: "GET",
                        headers: {
                    ...
                    await fetch('https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/accessrequest/getMyTotal', {
                        method: "GET",
                        headers: {
                            Authorization: "Bearer " + accessToken,
                        },
