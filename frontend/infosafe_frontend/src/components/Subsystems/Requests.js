    ...
    return (
        <div className="display">
            ...
            <div className="requestDiv">
                {selectedRequest === 'Create Support Requests' && <CreateSupportRequest selectedRequest={selectedRequest}/>}
                {selectedRequest === 'Create Access Requests' && <CreateAccessRequest selectedRequest={selectedRequest} />}
