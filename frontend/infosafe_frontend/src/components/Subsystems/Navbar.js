...
const NavBar = () => {
    ...
    useEffect(() => {
        ...
        fetch('https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/user/tokenValid', {
            method: 'POST',
            headers: {
    ...
    useEffect(() => {
        fetch('https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/user/getUserName', {
            method: "GET",
            headers: {
                Authorization: "Bearer " + sessionStorage.getItem('accessToken')
            }
