    ...
    const handleClick = (e, selectedRequest) => {
        ...
        switch (selectedRequest) {
            case 'Support Request':
                apiUrl = "https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/supportrequest/addSr";
                requestBody = support;
                break;
            case 'Asset Request':
                apiUrl = "https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/assetrequest/addAr";
                requestBody = asset;
                break;
            case 'Access Request':
                apiUrl = "https://ec2-174-129-77-195.compute-1.amazonaws.com:8080/api/accessrequest/addAr";
                requestBody = access;
                break;
            default:
