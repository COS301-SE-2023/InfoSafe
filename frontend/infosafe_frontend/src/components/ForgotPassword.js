...
export const ForgotPassword = () => {
    ...
    const handleClick = (e) => {
        ...
        fetch("http://ec2-52-91-180-105.compute-1.amazonaws.com:8080/api/forgot/request-reset", {
            method: "POST",
            headers: {
    ...
    const handleSecondClick = (e) => {
        const forgot = {email, otp, newPassword};
        fetch("http://http://ec2-52-91-180-105.compute-1.amazonaws.com:8080/api/forgot/reset-password", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: "Bearer " + sessionStorage.getItem("accessToken")
